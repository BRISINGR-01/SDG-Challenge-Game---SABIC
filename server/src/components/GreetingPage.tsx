...
const data = [
	<span style={{ fontSize: 20 }}>
		<span style={{ fontWeight: 700, fontSize: 30 }}>Dial it down</span>
		<br />
		Moving your thermostat down just two degrees in winter and up two degrees in summer could save about 2,000 pounds of
		carbon dioxide per year.
	</span>,
	<span style={{ fontSize: 20 }}>
		<span style={{ fontWeight: 700, fontSize: 30 }}>Turn it off</span>
		<br />
		Artificial lighting accounts for 44 percent of electricity use in office buildings. Make it a habit to turn off the
		lights when you're leaving any room for 15 minutes or more. Same goes for electronics- unplug electrical devices
		when you're not using them.
	</span>,
	<span style={{ fontSize: 20 }}>
		<span style={{ fontWeight: 700, fontSize: 30 }}>Use cold water</span>
		<br />
	...
	<span style={{ fontSize: 20 }}>
		<span style={{ fontWeight: 700, fontSize: 30 }}>Switch to e-billing</span>
		<br />
	...
	<span style={{ fontSize: 20 }}>
		<span style={{ fontWeight: 700, fontSize: 30 }}>Buy local</span>
		<br />
	...
	<span style={{ fontSize: 20 }}>
		<span style={{ fontWeight: 700, fontSize: 30 }}>Recycle</span>
		<br />
	...
	<span style={{ fontSize: 20 }}>
		<span style={{ fontWeight: 700, fontSize: 30 }}>Go solar</span>
		<br />
...
export default function GreetingPage() {
	...
	return (
		<div style={{ padding: "1em 2em", height: "80vh", width: "80vw" }}>
			<span style={{ fontSize: 20, color: "#939598" }}>Sustainability & Innovation</span>
			<br />
			<br />
